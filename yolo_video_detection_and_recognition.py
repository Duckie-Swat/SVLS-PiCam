...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', default='samples/IMG_0084.MOV', help="video source")
    parser.add_argument('--output', default='output_videos_detection_and_recognition_yolo/IMG_0084.mp4', help="video source")
    parser.add_argument('--classesFile', default='coco.names', help="Path to your classesFile.")
    args = parser.parse_args()

    modelWeights, video_source, output, classesFile = args.model, args.source, args.output, args.classesFile
